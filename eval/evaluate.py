...
def evaluate_results(input_file_path: str,
    ...
    print(f"  平均 Self-Correction Time:     {average_metrics['avg_self_adaptive_time']:.4f} s")
    ...
    print(f"  平均 Self-Correction Tokens:   {average_metrics['avg_self_adaptive_tokens']:.2f}")
